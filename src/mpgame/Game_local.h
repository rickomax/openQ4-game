...
// Savegame restore limits for game-owned variable lists. Entity table counts
// still use MAX_GENTITIES/MAX_CENTITIES directly.
const int MAX_SAVEGAME_ENTITY_REFS						= 1024;
const int MAX_SAVEGAME_CLIENT_ENTITY_REFS				= 1024;
const int MAX_SAVEGAME_BRITTLE_SHARDS					= 1024;
const int MAX_SAVEGAME_BRITTLE_DECALS_PER_SHARD			= 64;
const int MAX_SAVEGAME_BRITTLE_EDGES_PER_SHARD			= 64;	// MAX_POINTS_ON_WINDING
const int MAX_SAVEGAME_AI_ANIM_INFOS					= 256;
const int MAX_SAVEGAME_AI_LOOK_JOINTS					= 128;
const int MAX_SAVEGAME_AI_ACTION_ANIMS					= 256;
const int MAX_SAVEGAME_AI_TRIGGER_TESTS					= 256;
const int MAX_SAVEGAME_STATE_CALLS						= 256;
const int MAX_SAVEGAME_SCRIPT_FUNC_PARMS				= 64;
const int MAX_SAVEGAME_INVENTORY_ITEMS					= 512;
const int MAX_SAVEGAME_LEVEL_TRIGGERS					= 256;
const int MAX_SAVEGAME_PICKUP_ITEMS						= 512;
const int MAX_SAVEGAME_OBJECTIVES						= 256;
const int MAX_SAVEGAME_AAS_LOCATIONS					= 128;
const int MAX_SAVEGAME_GUI_EVENTS						= 256;
const int MAX_SAVEGAME_SPAWNER_ACTIVE					= 512;
const int MAX_SAVEGAME_SPAWNER_POINTS					= 512;
const int MAX_SAVEGAME_SPAWNER_CALLBACKS				= 256;
const int MAX_SAVEGAME_VEHICLE_POSITIONS				= 64;
const int MAX_SAVEGAME_VEHICLE_PARTS					= 256;
const int MAX_SAVEGAME_VEHICLE_WEAPONS					= 128;
const int MAX_SAVEGAME_VEHICLE_WEAPON_JOINTS			= 128;
const int MAX_SAVEGAME_TRAM_OCCUPANTS					= 64;
const int MAX_SAVEGAME_TRAM_WEAPONS						= 32;
...
const int MAX_SAVEGAME_CHAIN_LIGHTNING_TARGETS			= 64;
const int MAX_SAVEGAME_ROCKET_GUIDE_ENTS				= 128;
const int MAX_SAVEGAME_CLIENT_CRAWL_JOINTS				= 128;
const int MAX_SAVEGAME_PHYSICS_CONTACTS					= 256;
const int MAX_SAVEGAME_PHYSICS_CONTACT_ENTITIES			= 256;
const int MAX_SAVEGAME_STATIC_MULTI_STATES				= 256;
const int MAX_SAVEGAME_STATIC_MULTI_CLIP_MODELS			= 256;
const int MAX_SAVEGAME_TARGET_INFLUENCE_ITEMS			= 1024;
const int MAX_SAVEGAME_ACTOR_ENEMIES					= 512;
const int MAX_SAVEGAME_ACTOR_ATTACHMENTS				= 256;
const int MAX_SAVEGAME_ANIMATED_ANIMS					= 256;
...
// RAVEN END
	...
	virtual void			SpawnPlayer( int clientNum, bool isBot = false, const char* botName = "" );
	...
	virtual void			ServerClientBegin( int clientNum, bool isBot = false, const char* botName = "" );
